...
namespace CollectionViewDemos.ViewModels
{
    public class MonkeysViewModel : INotifyPropertyChanged
    {
        ...
        void CreateMonkeyCollection()
        {
            ...
            source.Add(new Monkey
            {
                Name = "Golden Snub-nosed Monkey Monkey",
                Location = "China",
            ...
            source.Add(new Monkey
            {
                Name = "Purple-faced Langur Monkey",
                Location = "Sri Lanka",
            ...
            source.Add(new Monkey
            {
                Name = "Golden Lion Tamarin Monkey",
                Location = "Brazil",
